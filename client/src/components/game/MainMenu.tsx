        ...
        <div className="flex flex-col items-center mb-2 relative">
          <div className="w-24 h-24 mb-4 animate-pulse">
            <img 
              ...
              alt="RES Logo" 
              className="w-full h-full object-contain rounded-xl shadow-lg shadow-amber-900/50" 
            />
          </div>
          <h1 className="text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-amber-300 to-pink-500 drop-shadow-md">RES</h1>
        </div>
        ...
        <DialogContent className="bg-gray-900 border-gray-800 text-white max-w-[90vw] sm:max-w-md" aria-describedby="about-description">
          <DialogHeader>
            <div className="flex justify-center mb-4">
              <img 
                src="/images/app-icon.jpg" 
                alt="RES Logo" 
                className="w-16 h-16 object-contain rounded-lg shadow-lg shadow-amber-900/50"
              />
            </div>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <p className="text-gray-300">Developed by: AVVINUM, Akkkha</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-300">v3.0</p>
            </div>
          </div>
